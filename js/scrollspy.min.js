...
+function (b) {
    ...
    c.prototype.refresh = function () {
        var a = this, c = "offset", g = 0;
        this.offsets = [];
        this.targets = [];
        this.scrollHeight = this.getScrollHeight();
        b.isWindow(this.$scrollElement[0]) || (c = "position", g = this.$scrollElement.scrollTop());
        this.$body.find(this.selector).map(function () {
            var a = b(this), a = a.data("target") || a.attr("href"), d = /^#./.test(a) && b(a);
            return d && d.length && d.is(":visible") && [[d[c]().top + g, a]] || null
        }).sort(function (a, b) {
            return a[0] -
                b[0]
        }).each(function () {
    ...
    c.prototype.process = function () {
        var a = this.$scrollElement.scrollTop() + this.options.offset, b = this.getScrollHeight(),
            c = this.options.offset + b - this.$scrollElement.height(), f = this.offsets, d = this.targets,
            k = this.activeTarget, e;
        ...
        for (e = f.length; e--;) k != d[e] && a >= f[e] && (void 0 === f[e + 1] || a < f[e +
        1]) && this.activate(d[e])
    };
    c.prototype.activate = function (a) {
        this.activeTarget = a;
        this.clear();
        b(this.selector + '[data-target="' + a + '"],' + this.selector + '[href="' + a + '"]').parents("li").addClass("active").trigger("activate.bs.scrollspy")
    };
    ...
    b.fn.scrollspy = function (a) {
        return this.each(function () {
            var h = b(this), g = h.data("bs.scrollspy"), f = "object" == typeof a && a;
